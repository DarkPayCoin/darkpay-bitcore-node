...
**Note**: To install services [insight-api](https://github.com/DarkPayCoin/darkpay-insight-api) and [insight-ui](https://github.com/DarkPayCoin/darkpay-insight-ui) you'll need to clone the repositories locally.
